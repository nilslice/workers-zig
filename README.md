...
- **TCP (connect handler)** — inbound and outbound TCP socket support
...
pub fn connect(socket: *workers.Socket, env: *workers.Env, ctx: *workers.Context) !void
```
...
| [05-tcp-echo](examples/05-tcp-echo/) | TCP connect handler + outbound HTTP fetch |
