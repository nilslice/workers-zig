...
fn handleIndex(_: *workers.Request, env: *workers.Env, _: *workers.Context, _: *router.Params) !workers.Response {
    const greeting = (try env.get("GREETING")) orelse "Hello from Zig on Cloudflare Workers!";
    return workers.Response.ok(greeting);
}

fn handleGreet(_: *workers.Request, _: *workers.Env, _: *workers.Context, params: *router.Params) !workers.Response {
...
fn handleEcho(request: *workers.Request, _: *workers.Env, _: *workers.Context, _: *router.Params) !workers.Response {
